...
export const ChatView = () => {
    ...
    return (
        <div className="h-[calc(100vh-4rem)] flex">
            {/* Chat List */}
            <div className="w-80 border-r border-(--border-1) bg-(--bg-2) overflow-y-auto">
                <div className="p-4 border-b border-(--border-1)">
                    <h2 className="text-xl font-bold text-(--text-1)">{t('chats')}</h2>
                </div>
            ...
            {/* Chat Window */}
            <div className="flex-1 flex flex-col bg-(--bg-1)">
                {/* Chat Header */}
                <div className="p-4 bg-(--bg-2) border-b border-(--border-1) flex items-center gap-3">
                    <Avatar 
                    ...
                    />
                    <div>
                        <h3 className="font-semibold text-(--text-1)">{selectedChat.user.name}</h3>
                        <p className="text-xs text-(--text-2)">{t('online')}</p>
                    </div>
                </div>
                        ...
                        return (
                            ...
                            >
                                <Avatar 
                                    ...
                                    size="sm"
                                />
                                <div className={`max-w-md ${isSent ? 'items-end' : ''}`}>
                ...
                <div className="p-4 bg-(--bg-2) border-t border-(--border-1)">
                    <div className="flex gap-3">
                        <input
                            ...
                            className="flex-1 px-4 py-3 bg-(--bg-1) border border-(--border-1) rounded-lg text-(--text-1) placeholder:text-(--text-2) outline-none focus:border-(--button-1)"
                        />
                        <button className="px-6 py-3 bg-(--button-1) text-(--button-1-text) rounded-lg hover:scale-105 transition-transform">
